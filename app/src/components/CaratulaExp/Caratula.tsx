            ...
            <article class="mx-8">
                ...
                <Show when={trabajador() && currTrabajador()}>
                    <div class="w-full flex flex-col my-4">
                        <h4 class="font-bold tracking-wider text-lg text-gray-500 uppercase">Generales</h4>
                        <div class="w-full flex flex-col items-center">
                            <div class="w-5/6 flex flex-row justify-start items-center">
                        ...
                        <h4 class="font-bold tracking-wider text-lg text-gray-500 uppercase">Ingreso</h4>
                        <div class="w-full flex flex-col items-center">
                            <div class="w-5/6 flex flex-row justify-start items-center">
                        ...
                        <h4 class="font-bold tracking-wider text-lg text-gray-500 uppercase">Localización</h4>
                        <div class="w-full flex flex-col items-center">
                            <div class="w-5/6 flex flex-row justify-start items-center">
                        ...
                        <h4 class="font-bold tracking-wider text-lg text-gray-500 uppercase">Nómina</h4>
                        <div class="w-full flex flex-col items-center">
                            <div class="w-5/6 flex flex-row justify-start items-center">
                        ...
                        <h4 class="font-bold tracking-wider text-lg text-gray-500 uppercase">Equipo de Protección Personal</h4>
                        <div class="w-full flex flex-col items-center">
                            <div class="w-5/6 flex flex-row justify-start items-center">
                        ...
                        <h4 class="font-bold tracking-wider text-lg text-gray-500 uppercase">Varios</h4>
                        <div class="w-full flex flex-col items-center">
                            <div class="w-5/6 flex flex-row justify-start items-center">
                                <h5 class="font-bold tracking-wide w-2/3">Calzado Medida:</h5>
